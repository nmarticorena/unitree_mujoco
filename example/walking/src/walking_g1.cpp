...
void Custom::LowStateMessageHandler(const void *message)
{
    ...
    std::cout << state->motor_state()[0].q() << std::endl;
}
...
{
    Ort::Env env(ORT_LOGGING_LEVEL_WARNING, "walking_g1");
    // Todo make it that is a variable 
    std::string modelFilepath{"policy.onnx"};
